...
communityMemberRoleId = utils.getDbField(configCollection, "IDs", 'community_member_role_id')
communityMemberRoleId = communityMemberRoleId if isinstance(communityMemberRoleId, int) else -1
